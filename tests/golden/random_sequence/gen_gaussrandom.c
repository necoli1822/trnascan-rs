...
/* Gaussrandom() - Box-Muller transform implementation */
float Gaussrandom(float mean, float stddev)
{
  static float a[32] = {
...
int main(void)
{
  ...
  /* Generate 100 Gaussian random values with seed 666 and mean=0, stddev=1 */
  for (i = 0; i < 100; i++) {
    value = Gaussrandom(0.0, 1.0);
    printf("gauss[%d] = %.10f\n", i, value);
  }
